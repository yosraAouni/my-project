    ...
    <div class="row">
        ...
        <div class="our_solution_category">
            ...
            <div class="solution_card">
                ...
                <h3>Création de la Société centrale</h3>
                </div>
                <div class="solu_description">
                <p>
                Elle suspend ses activités au moment même (10 janvier 1850) où est fondée la Société centrale d'éducation et d'assistance pour les sourds-muets en France. 
                </p>
            ...
            <div class="solution_card">
                ...
                <div class="solu_title">
                <h3>Directeur Géneral</h3>
                </div>
                <div class="solu_description">
                <p>
                    <h3>M. Ben Fadhel Zied</h3>
                    Employé: mai 1995 - aujourd’hui26 ans 11 mois Tunisie
                    Formation: Maitrise en Economie et Relation internasionales
                </p>
                <button type="button" class="read_more_btn">Read More</button>
                </div>
            </div>
            ...
            <div class="solution_card">
                ...
                <div class="solu_title">
                <h3>Personnel Staff</h3>
                </div>
                <div class="solu_description">
                <p>
                Taille de l’entreprise : 1001-5 000 employés
                </p>
                <button type="button" class="read_more_btn">Read More</button>
                </div>
            </div>
